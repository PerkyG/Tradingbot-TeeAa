...
const QUESTION_CATEGORIES = {
  ...
  voorbereiding: [
    ...
    {
      question: "Ben je fysiek en mentaal voorbereid? Deel een korte voice note met de risicos op dat vlak voor vandaag.",
      type: "open",
      excludeFromScoring: false
    },
    {
  ...
  discipline: [
    ...
    {
      question: "Wat verbeter je in je discipline? Reflectie en vooruitblik. Ideeen via voice.",
      type: "open",
      excludeFromScoring: false
    }
  ],
  ...
  trades: [
    ...
    {
      question: "Volgende trade plan? Nieuwe high timeframe ideeen opgedaan of herinnerd? Deel idee.",
      type: "open",
      excludeFromScoring: false
    }
  ],
  ...
  gezondheid: [
    ...
    {
      question: "Mentale vs lichaam connectie gezondheid: Hoe voel je je?",
      type: "open",
      excludeFromScoring: false
    }
  ],
  ...
  marktanalyse: [
    ...
    {
      question: "start here gecheckt? typeer markt met .",
      type: "open",
      excludeFromScoring: false
    },
    {
